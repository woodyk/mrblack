...
def setup_venv():
    ...
    print("📦 Installing release tools...")
...
def run(cmd: str, step_name: str, allow_fail=False):
    ...
    try:
        ...
        msg = f"❌ Step '{step_name}' failed with exit code {e.returncode}."
...
def main(dry_run=False):
    ...
    print("📄 Writing pyproject.toml and MANIFEST.in...")
    ...
    if FAILED_STEPS:
        for step, msg in FAILED_STEPS:
            print(f"⚠️  {msg}")
        print("⚠️  Review the above issues before considering this release final.")
    else:
